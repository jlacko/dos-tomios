# načte dataset nových tweetů a rozbije ho do datasetu slov, který uloží do složky data
...
tweets <- read_csv('./data/nove-tweety.csv') # nové tweety / ne staré :)
...
write_csv(words, './data/nova-slova.csv')